    ...
    NowFn: Fn() -> I + Send + Sync + Unpin + 'static,
{
    ...
    pub fn new_with_client_and_jitter(
        ...
        Ok(Arc::new(Self {
            ...
            item_callbacks_register_lock: parking_lot::Mutex::new(()),
        }))
    }
    ...
    NowFn: Fn() -> I + Send + Sync + Unpin + 'static,
{
    ...
    /// S3Store is a leaf — `mark_stable` is a no-op (S3 owns its own
