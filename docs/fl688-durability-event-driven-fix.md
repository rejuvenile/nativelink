...
- **NEXT (blocked on the F2 trigger decision):** pick the trigger (recommend advertise-on-upload-completion/AlreadyExists) → doc fixes F1/F3/F5 → re-spec V3 → implement → final cadre.
