...
**Location:** `/src/nativelink/nativelink-scheduler/src/cache_lookup_scheduler.rs:174-255` and `/src/nativelink/nativelink-service/src/cas_server.rs:696-710`
...
**Current bottleneck:** The capabilities server at `/src/nativelink/nativelink-service/src/capabilities_server.rs:143-144` advertises `supported_compressors: vec![]` and `supported_batch_update_compressors: vec![]`. While tonic-level compression is configurable (line 169-175 of `nativelink.rs`), the REAPI-level compressors are not advertised. This means `BatchReadBlobs` and `BatchUpdateBlobs` use `compressor::Value::Identity` (no compression) as seen at `/src/nativelink/nativelink-store/src/grpc_store.rs:285` and `/src/nativelink/nativelink-service/src/cas_server.rs:413`.

**Location:**
- `/src/nativelink/nativelink-service/src/capabilities_server.rs:143-144`
- `/src/nativelink/nativelink-service/src/cas_server.rs:413`
- `/src/nativelink/nativelink-store/src/grpc_store.rs:285`
...
**Current bottleneck:** The action pipeline at `/src/nativelink/nativelink-worker/src/local_worker.rs:1334-1340` is:
```
...
**Location:** `/src/nativelink/nativelink-worker/src/local_worker.rs:1334-1340`
...
**Location:**
- `/src/nativelink/nativelink-scheduler/src/api_worker_scheduler.rs:1881-1920`
- `/src/nativelink/nativelink-worker/src/running_actions_manager.rs:1186-1242`
...
**Current bottleneck:** At `/src/nativelink/nativelink-worker/src/local_worker.rs:1391-1402`, the worker sends `execution_response` first, then `execution_complete` to release the worker slot:
...
**Location:** `/src/nativelink/nativelink-worker/src/local_worker.rs:1391-1402`
...
**Location:**
- `/src/nativelink/nativelink-scheduler/src/api_worker_scheduler.rs:1752-1861`
- `/src/nativelink/nativelink-worker/src/running_actions_manager.rs:1082-1093`
...
**Location:** `/src/nativelink/nativelink-scheduler/src/api_worker_scheduler.rs:1999-2026`
...
**Location:** `/src/nativelink/nativelink-service/src/execution_server.rs:356-374`
...
**Location:** `/src/nativelink/nativelink-scheduler/src/simple_scheduler.rs:228-321`
...
**Location:**
- `/src/nativelink/nativelink-worker/src/running_actions_manager.rs:828` (`acceptable_compressors: vec![]`)
- `/src/nativelink/nativelink-service/src/cas_server.rs:413` (`compressor: Identity`)
...
- `/src/nativelink/nativelink-worker/src/running_actions_manager.rs`
- `/src/nativelink/nativelink-scheduler/src/api_worker_scheduler.rs`
- `/src/nativelink/nativelink-worker/src/local_worker.rs`
- `/src/nativelink/nativelink-service/src/capabilities_server.rs`
- `/src/nativelink/nativelink-service/src/worker_api_server.rs`
